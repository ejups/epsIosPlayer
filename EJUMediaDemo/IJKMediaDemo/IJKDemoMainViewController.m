...
- (void)viewDidLoad {
    ...
    [self.navigationItem setRightBarButtonItem:[[UIBarButtonItem alloc] initWithTitle:@"Setting" style:UIBarButtonItemStyleDone target:self action:@selector(onClickPlayButton)]];
}

- (void)onClickPlayButton {
 
    [self.navigationController pushViewController:[[IJKSettingViewController alloc] init] animated:YES];
