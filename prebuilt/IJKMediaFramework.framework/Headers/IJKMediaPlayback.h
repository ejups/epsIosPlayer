...
typedef NS_ENUM(NSInteger, IJKMPMovieRotationAngle) {
    IJKMPMovieRotationAngle0,
    IJKMPMovieRotationAngle90,
    IJKMPMovieRotationAngle180,
    IJKMPMovieRotationAngle270
};

typedef NS_ENUM(NSInteger, IJKMPMovieMirror) {
    IJKMPMovieMirrorNone,
    IJKMPMovieMirrorLeftToRight,
    IJKMPMovieMirrorUptoDown
};

typedef NS_ENUM(NSInteger, IJKMPMovieVolume) {
    IJKMPMovieVolumeNone,
    IJKMPMovieVolumeUp,
    IJKMPMovieVolumeDown,
    IJKMPMovieVolumeMute,
};
...
typedef NS_ENUM(NSInteger, IJKMPMovieScalingMode) {
    ...
    //IJKMPMovieScalingModeAspectFit_4ratio3,
    //IJKMPMovieScalingModeAspectFit_16ratio9
};
...
- (BOOL)isPlaying;
- (void)shutdown;
- (void)record:(NSString *)file_name;
- (void)rotate:(IJKMPMovieRotationAngle)angle;
- (void)mirror:(IJKMPMovieMirror)direction;
- (void)setVolume:(IJKMPMovieVolume)volume;
...
@property (nonatomic) int maxCacheMsTime;
